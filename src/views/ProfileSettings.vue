  ...
  <div class="max-w-2xl mx-auto p-6 space-y-8">
      ...
      <div class="p-6 space-y-4">
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-2 border rounded-xl outline-none focus:ring-2 focus:ring-blue-500 transition"
          />
        </div>
      </div>
    </section>
      ...
      <div class="p-6 space-y-6">
        <div v-if="formData.pinEnabled">
          <p class="text-sm text-gray-500 mb-4">
            Gib hier deine neue PIN ein (4-6 Ziffern). Diese wird für den Schnell-Login an
            zertifizierten Terminals verwendet.
          </p>
    ...
    <div class="flex justify-end gap-4">
      ...
      <button
        ...
        class="px-8 py-2 bg-blue-600 text-white rounded-xl font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 disabled:opacity-50 disabled:shadow-none transition"
      >
    ...
    <div
      ...
      "
      class="p-4 rounded-xl text-center font-medium border animate-in fade-in slide-in-from-bottom-4"
    >
      {{ statusMsg.text }}
    </div>
  </div>
...
<style scoped>
/* Optional: Animation für die Status-Meldung */
.animate-in {
